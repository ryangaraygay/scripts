...
destination_folder="/Users/ryangaraygay/Library/Mobile Documents/com~apple~CloudDocs/MyFiles/backups/MotiveWave Logs"  # **CHANGE THIS TO YOUR DESTINATION FOLDER**
